...
export const ForgotPassword = () => {
  ...
  const handleSubmit = (event) => {
    ...
    setLoading(true);
    axios
      .post("api/person/forgot-password", body)
      .then((res) => {
        toast.success(
          "Your request has been send successfully! Please check your email to change your password.",
          ...
          <Container component="main" maxWidth="xs">
            ...
            >
              ...
              <Typography
                component="h1"
                variant="h5"
                style={{ marginLeft: "26%", marginTop: "13%" }}
              >
                Forgot Password
              </Typography>
              <Box
              ...
              >
                ...
                <Link style={{ marginLeft: "4%" }} href="/" variant="body2">
                  Go to sign in page
                </Link>
                <LoadingButton
                  type="submit"
